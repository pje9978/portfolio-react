    ...
    return (
         <>
            <section id="about" className=" w-screen my-24">
                <div role="group" aria-label="conainer" className="container mx-auto lg:w-2/3 md:w-2/3 w-full  flex flex-wrap justify-start px-6 -mt-56 sm:mt-0">
                    <header className="w-fit text-left">
                    ...
                    <article className="reveal reveal_LTR max-w-fit xl:w-2/3 lg:w-full md:w-full sm:w-full w-full">
                        <h4 className="leading-relaxed font-small text-lg font-normal mt-4 text-left">
