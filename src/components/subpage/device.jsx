function Device({device}) {
    const desktop = device.filter(item => item.includes("데스크탑")).toString();
    const tablet = device.filter(item => item.includes("태블릿")).toString();
    const mobile = device.filter(item => item.includes("모바일")).toString();
    ...
    return ( <>
        <div className="deviceArea group flex justify-center items-center gap-3 mt-12">
            ...
            { tablet ?
                <div className="tablet flex flex-col justify-center items-center">
                    <svg className="w-[44px] opacity-60" fill="#ffefe5" viewBox="0 0 64 64" data-name="Layer 1"
                        id="Layer_1" xmlns="http://www.w3.org/2000/svg">
            ...
            {mobile ?
                <div className="mobile flex flex-col justify-center items-center">
                    <svg className="w-[44px] opacity-60" fill="#ffefe5" viewBox="0 0 64 64" data-name="Layer 1"
                        id="Layer_1" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
